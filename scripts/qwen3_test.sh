...
# Ray
RAY_ADDRESS="10.122.199.93:6379"
WORKING_DIR=${WORKING_DIR:-"${PWD}"}
RUNTIME_ENV=${RUNTIME_ENV:-"${WORKING_DIR}/verl/trainer/runtime_env.yaml"}
NNODES=2
# Paths
RAY_DATA_HOME=${RAY_DATA_HOME:-"${HOME}/verl"}
MODEL_PATH="/opt/tiger/modellink/hxb/Qwen3-30B-A3B-DAPO-Model-Dataset/Qwen3-30B-A3B"
CKPTS_DIR=./ckpts
TRAIN_FILE="/opt/tiger/modellink/hxb/Qwen3-30B-A3B-DAPO-Model-Dataset/DAPO-Math-17k/data/dapo-math-17k.parquet"
TEST_FILE="/opt/tiger/modellink/hxb/Qwen3-30B-A3B-DAPO-Model-Dataset/aime_2024/train.parquet"
