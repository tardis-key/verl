...
MODEL_PATH=/home/huxiaobo/data/model/Qwen2.5-0.5B-Instruct
# hf download "${MODEL_ID}" --local-dir "${MODEL_PATH}"

# NPU profiling config (aligned with run_qwen2_5.sh)
SAVE_PATH="/home/huxiaobo/data/profile_data/discrete_analyse_fully_test_3"
LEVEL="level1"
CONTENTS=['npu','cpu']
ANALYSIS=False
PROFILE_STEPS="[1,2]"
PROFILE_ROLLOUT_STEPS="[1,2,3,4,5]"
PROFILE_RANKS_ALL=True
DISCRETE=True
PROFILER_ENABLE=True

SKIP_ENABLE=False
SKIP_DUMP_DIR=/home/huxiaobo/data/rollout_dump_fullyasync
SKIP_STEPES=[1,2,3]
SKIP_ACTION=repeat
...
common_params=(
    data.train_files=/home/huxiaobo/data/dataset/gsm8k/train.parquet \
    data.val_files=/home/huxiaobo/data/dataset/gsm8k/test.parquet \
    ...
    skip.rollout.steps=$SKIP_STEPES
...
if [ "${ACTOR_STRATEGY}" == "fsdp2" ]; then
    ...
    python3 -m verl.experimental.fully_async_policy.fully_async_main \
        ...
        actor_rollout_ref.ref.profiler.enable=${PROFILER_ENABLE} \
        actor_rollout_ref.ref.profiler.tool=npu \
        ...
        actor_rollout_ref.rollout.profiler.enable=${PROFILER_ENABLE} \
        actor_rollout_ref.rollout.profiler.tool=npu \
        actor_rollout_ref.rollout.profiler.all_ranks=${PROFILE_RANKS_ALL} \
        actor_rollout_ref.rollout.profiler.tool_config.npu.discrete=${DISCRETE} \
        ...
        +global_profiler.rollout_steps=${PROFILE_ROLLOUT_STEPS} \
